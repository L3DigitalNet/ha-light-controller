...
- Detect handoff layout before review work: V2 repos read `docs/handoff/state.md` and `docs/handoff/conventions.md`; V1 legacy repos read `docs/handoff.md` and `docs/handoff/conventions.md`. Treat those files as primary review inputs.
