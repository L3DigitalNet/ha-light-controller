...
- Detect handoff layout before review work: V2 repos read `docs/state.md` and `docs/conventions.md`; V1 legacy repos read `docs/handoff.md` and `docs/conventions.md`. Treat those files as primary review inputs.
